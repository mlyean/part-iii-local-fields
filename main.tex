...
\begin{corollary}Let $(K, \abs{\cdot})$ be a complete, non-archimedean discretely valued field. Let $L / K$ be a finite extension. Then
    \begin{enumerate}
...
\begin{proof}\phantom{}
    \begin{enumerate}
        \item Let $v$ be a valuation on $K$ and $v_L$ be a valuation on $L$ such that $v_L$ extends $v$.
    \end{enumerate}
\end{proof}
