...
\begin{example}
    ...
    We have an isomorphism $\ZZ_p^\times \cong (\ZZ / p \ZZ)^\times \times (1 + p \ZZ_p) \cong \ZZ / (p-1) \ZZ \times \ZZ_p$, where the first isomorphism is $x \mapsto (x \pmod{p}, \frac{x}{[x \pmod{p}]})$, where $[\cdot] : \FF_p \to \ZZ_p$ is the Teichm\"uller lift.\footnote{The existence of the Teichm\"uller lift makes the exact sequence $1 \rightarrow 1 + p \ZZ_p \rightarrow \ZZ_p^\times \rightarrow (\ZZ / p \ZZ)^\times \rightarrow 1$ split.}
