...
\begin{theorem}\label{thm:7_8}
    Let $K$ be a local field of equal characteristic $p > 0$. Then $K \cong \bF_{p^n}((t))$ for some prime $n \ge 1$.
\end{theorem}
\begin{proof}
...
\begin{proof}
    ...
    \begin{align*}
        ...
        &\le \abs{y}^m B (m+1)
    \end{align*}
    Taking $m$\textsuperscript{th} roots, $\abs{x + y} \le \abs{y} (B (m + 1))^\frac{1}{m}$. Taking $m \to \infty$, we get $\abs{x + y} \le y$.
\end{proof}
