...
\begin{remark}\phantom{}
    \begin{enumerate}
        \item If $y_i = \sum_{j=1}^n a_{ij}x_j$, where $a_{ij} \in K$, then
            \begin{equation*}
...
\begin{proof}
    ...
    Assume that $\Char K = p$. We use strong induction on $n \ge 1$. Suppose that $h_1(X), \ldots, h_{n-1}(X)$ are irreducible. Then $f_{n-1}(X) = f_0(X) h_1(X) \ldots h_{n-1}(X)$ is a product of separable irreducible polynomials of distinct degrees, hence separable. We have
    \begin{equation*}
